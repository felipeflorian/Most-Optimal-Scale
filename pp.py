...
#G.add_edge("Bogota","Estambul",weight=)####
#G.add_edge("Bogotá","New York",weight=5.45)#IMPORTANTE
#G.add_edge("New York","Lisboa",weight=6.45)
#G.add_edge("Lisboa","Estambul",weight=4.31)
...
##############G.add_edge("Taskent","Kabul",weight=1.30)#NUEVA
...
G.add_edge("París","Abuya",weight=6.03)####8.35
G.add_edge("Abuya","Luanda",weight=6.47)####8.35
...
#G.add_edge("Honolulu","Vancouver",weight=5.55)
G.add_edge("Honolulu","Apia",weight=5.50)#Samoa
...
G.add_edge("Los Ángeles","Honolulu",weight=5.37)#################13.31
#G.add_edge("Honolulu","Apia",weight=5.50)#Samoa
G.add_edge("Apia","Auckland",weight=4.05)#################13.31
...
#G.add_edge("Los Ángeles","Honolulu",weight=5.37)####9.51
#G.add_edge("Tokio","Honolulu",weight=6.55)
...
G.add_edge("New York","Los Ángeles",weight=6.11)####15.30
#G.add_edge("Los Ángeles","Honolulu",weight=5.37)####9.51
#G.add_edge("Tokio","Honolulu",weight=6.55)
#G.add_edge("Tokio","Hong Kong",weight=4.12)
...
G.add_edge("Dallas","Los Ángeles",weight=2.59)####13.22
#G.add_edge("Los Ángeles","Honolulu",weight=5.37)####9.51
#G.add_edge("Tokio","Honolulu",weight=6.55)
...
G.add_edge("Atlanta","Los Ángeles",weight=4.24)####14.55
#G.add_edge("Los Ángeles","Honolulu",weight=5.37)####9.51
#G.add_edge("Tokio","Honolulu",weight=6.55)
#G.add_edge("Tokio","Pekín",weight=3.07)
#G.add_edge("Pekín","Kaesong",weight=1.45)
...
#G.add_edge("Ámsterdam","Rabat",weight=5.44)
...
G.add_edge("Jartum","Nairobi",weight=2.54) ##########nueva
G.add_edge("Nairobi","Harare",weight=2.56) ########nueva(zimbabue)
