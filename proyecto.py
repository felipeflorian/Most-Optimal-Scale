...
G.add_edge("Milán","New York",weight=) ####9.17
...
G.add_edge("Bogotá","Toronto",weight=5.55)####6.10
...
G.add_edge("Santo Domingo","París",weight=)####.27
...
G.add_edge("Moscú","New York",weight=)####10.15
