...
G.add_edge("Madrid","Paris",weight=1.50)
G.add_edge("Londres","Paris",weight=0.56)
G.add_edge("Milán","Madrid",weight=1.59)
G.add_edge("Milán","Paris",weight=1.19)
...
G.add_edge("Paris","Moscú",weight=3.34)
...
G.add_edge("Paris","Barcelona",weight=1.35)
...
G.add_edge("Paris","Montpellier",weight=1.16)
G.add_edge("Santo Domingo","Paris",weight=)#####9.27
...
G.add_edge("Paris","Varsovia",weight=2.11)
